...
def main_menu():
    while True:
        ...
        MENU_TEXT = fuentes(70).render("Operacion Libertad", True, "#cb08fc")

        MENU_RECT = MENU_TEXT.get_rect(center=(W // 2, H // Aquí tienes la continuación del código:
